"""Central configuration — all pipeline stages read values here."""

# ── Required ──────────────────────────────────────────────────────────────────
BUCKET: str = "tokenizer-corpus"
RUN_ID: str = "run_001"
...
# ── Stage 7: Rebalance ────────────────────────────────────────────────────────
MAX_LANG_FRACTION = 0.3
TARGET_DOCS       = 0       # 0 = keep all after capping
RANDOM_SEED       = 42

# ── Stage 8: Train & Validate ─────────────────────────────────────────────────
VOCAB_SIZE          = 32_000
MIN_FREQUENCY       = 2
NUM_VALIDATION_DOCS = 1_000
